 ...
 SELECT `EdoPosFin`.`CUENTA`, `Cuentas`.`AÑO`, `Cuentas`.`SALDOI`, `Cuentas`.`CAR01`, `Cuentas`.`ABO01`, `Cuentas`.`CAR02`, `Cuentas`.`ABO02`, `Cuentas`.`CAR03`, `Cuentas`.`ABO03`, `Cuentas`.`CAR04`, `Cuentas`.`CAR05`, `Cuentas`.`ABO04`, `Cuentas`.`ABO05`, `Cuentas`.`CAR06`, `Cuentas`.`ABO06`, `Cuentas`.`CAR07`, `Cuentas`.`ABO07`, `Cuentas`.`CAR08`, `Cuentas`.`ABO08`, `Cuentas`.`CAR09`, `Cuentas`.`ABO09`, `Cuentas`.`CAR10`, `Cuentas`.`ABO10`, `Cuentas`.`CAR11`, `Cuentas`.`ABO11`, `Cuentas`.`CAR12`, `Cuentas`.`ABO12`, `EdoPosFin`.`AGRUPA1`, `GruContabEPF`.`GRUPO`, `EdoPosFin`.`AGRUPA2`, `GruContabEPF`.`CONCEPTO`
...
OR
 ...
 WHERE  (Cuentas."AÑO" = 2016  or Cuentas."AÑO" = 2015) and GruContabEPF."EMISION"  = 1
