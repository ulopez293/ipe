 ...
 SELECT `Cuentas`.`SALDOI`, `Cuentas`.`CAR01`, `Cuentas`.`CAR02`, `Cuentas`.`CAR03`, `Cuentas`.`CAR04`, `Cuentas`.`CAR05`, `Cuentas`.`CAR06`, `Cuentas`.`CAR07`, `Cuentas`.`CAR08`, `Cuentas`.`CAR09`, `Cuentas`.`CAR10`, `Cuentas`.`CAR11`, `Cuentas`.`CAR12`, `Cuentas`.`ABO01`, `Cuentas`.`ABO02`, `Cuentas`.`ABO03`, `Cuentas`.`ABO04`, `Cuentas`.`ABO05`, `Cuentas`.`ABO06`, `Cuentas`.`ABO07`, `Cuentas`.`ABO08`, `Cuentas`.`ABO09`, `Cuentas`.`ABO10`, `Cuentas`.`ABO11`, `Cuentas`.`ABO12`, `EdoResulAna`.`CTAARM1`, `EdoResulAna`.`CTAARM2`, `EdoResulAna`.`CTAARM3`, `EdoResulAna`.`CTAARM4`, `EdoResulAna`.`CLAVE`, `EdoResulAna`.`AÑO`, `GrupoCtaArm`.`NOMBREARM`, `GrupoCtaArm2`.`NOMBREARM`, `GrupoCtaArm3`.`NOMBREARM`, `GrupoCtaArm4`.`NOMBREARM`
 ...
 WHERE   AND
    EdoResulAna."AÑO" = 2016 and EdoResulAna."CTAARM4" < '2.1'
 ORDER BY `EdoResulAna`.`CTAARM1`, `EdoResulAna`.`CTAARM2`, `EdoResulAna`.`CTAARM3`, `EdoResulAna`.`CTAARM4`
