...
async function rptcgctascolectivas (req, res, conexion) {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <h5 class="mb-1">Cuentas colectivas de </h5>
                </div>
                <div class="col-1"></div>
            </div>
        </div>
    `
   	...
   	let sqlLimpio = await consultaLimpia('rptcgctascolectivas.sql',req.params)
                    ...
                    <table class="table mt-5">
                        ...
                        ${salida.recordset.map((element) => {
                            ...
                            <tr>
                                ...
                                <td>${element.SUBCTA ?? ''}</td>
                                <td>${element.SSUBCTA ?? ''}</td>
...
module.exports = rptcgctascolectivas