...
let cabeceraTemplate = `
    <div class="container">
        <div class="row">
            ...
            <div class="col-10">
                <h2 class="mb-1">Instituto de Pensiones del Estado</h2>
                <h3 class="mb-1">Subdirección de Finanzas</h3>
                <h4 class="mb-1">Libro Mayor</h4>
            </div>
            <div class="col-1"></div>
        </div>
    </div>
...
async function rptcglibromayor (req, res, conexion) {
   	let sqlLimpio = await consultaLimpia('rptcglibromayor.sql')
                    ...
                    <table class="table mt-5">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Tipo de Pol.</th>
                                <th scope="col">Num. Pol</th>
                                <th scope="col">Fecha</th>
                                <th scope="col">Concepto</th>
                                <th scope="col">Sald. Ini</th>
                        ...
                        ${salida.recordset.map((element) => {
                            ...
                            <tr>
                                ...
                                <td>${element.SALDOI ?? ''}</th>
                                <td>${element.DEBE ?? ''}</th>
                                <td>${element.CLAVE ?? ''}</th>
                                <td>${element.IMPORTE ?? ''}</th>
                            </tr>
                            `
                        }).toString().replaceAll(',', '')}
                        </tbody>
...
module.exports = rptcglibromayor